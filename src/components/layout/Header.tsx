...
function Header() {
  ...
  return (
    <nav ref={headerRef} className={`fixed top-4 left-0 right-0 z-10 flex items-center justify-center p-3 transition-colors w-[20rem] md:w-[26.25rem] gap-5 mx-auto text-base md:text-lg font-semibold rounded-full outline-1 outline ${classEffect}`}>
